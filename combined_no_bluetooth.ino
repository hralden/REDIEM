...
void loop() {
  ...
  //Flex Sensors
  R1 = calculate_flex_R(flex_1);
  Serial.print(R1);
  Serial.print(", ");
  R2 = calculate_flex_R(flex_2);
  Serial.print(R2);
  Serial.print(", ");
  R3 = calculate_flex_R(flex_3);
  Serial.print(R3);
  Serial.print(", ");
  R4 = calculate_flex_R(flex_4);
  Serial.print(R4);
  Serial.print(",");
 ...
 Serial.print(Y);
  ...
  Vout_EMG = Vout_EMG * 1000;
  Serial.print(Vout_EMG);
  Serial.print(", ");
...
int calculate_flex_R(int pin){
  flex = analogRead(pin);
  vout = float((flex * Vin) /1024.0);
  resistance = float(((Vin / vout) -1)) * R0;
  return resistance;
}
